...
function Starlight:CreateWindow(WindowSettings)
	...
	do
		...
		pcall(function()
			...
			AcrylicObject.Frame.ClipsDescendants = true
			AcrylicObject.Frame.Visible = false
			...
			AcrylicObject2.Frame.ClipsDescendants = true
			AcrylicObject2.Frame.Visible = false
		...
		mainWindow.Sidebar.ClipsDescendants = true
